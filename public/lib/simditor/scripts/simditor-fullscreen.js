(function() {
  ...
  (function(factory) {
    ...
    FullScreenButton = (function(_super) {
      ...
      // by harttle, set this to enable fullscreen button when markdown btn once clicked
      ...
      FullScreenButton.prototype.doFullScreen = function() {
        ...
        return this.editor.body.css("maxHeight", wrapperHeight - toolbarHeight + "px").css("overflow", "auto");
      };
