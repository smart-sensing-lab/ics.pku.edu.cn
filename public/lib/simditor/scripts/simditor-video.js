(function() {
    ...
    (function(factory) {
        ...
        $.extend(Simditor.i18n['zh-CN'], {
            'video': '插入视频',
            'videoSize': '视频尺寸',
            'videoPlaceholder': '粘贴视频地址',
            'uploadVideoBtn': '确认插入视频',
        });
        VideoButton = (function(superClass) {
            ...
            VideoButton.prototype.videoPoster = 'http://tmy-assets.oss-cn-beijing.aliyuncs.com/img%2Fvideo-placeholder.png';
